...
def get_twitter_user_data(driver, input_ID):
    ...
    try:
        ...
        account_name_element = driver.find_element(By.CSS_SELECTOR,
        'div.css-175oi2r.r-1awozwy.r-18u37iz.r-1wbh5a2.r-dnmrzs > div > a > div > div.css-146c3p1.r-bcqeeo.r-1ttztb7.r-qvutc0.r-37j5jr.r-a023e6.r-rjixqe.r-b88u0q.r-1awozwy.r-6koalj.r-1udh08x.r-3s2u2q > span > span')
        ...
        print("SYSTEM: 에러가 발생했습니다.")
        print(f"에러 타입: {type(e).__name__}")  # 에러의 클래스 이름
        print(f"에러 메시지: {e}")  # 에러 메시지
...
PAGE_login_field = 'r-30o5oe.r-1dz5y72.r-13qz1uu.r-1niwhzg.r-17gur6a.r-1yadl64.r-deolkf.r-homxoj.r-poiln3.r-7cikom.r-1ny4l3l.r-t60dpp.r-fdjqy7'
PAGE_Account_info_Num_of_follower = '#react-root > div > div > div.css-175oi2r.r-1f2l425.r-13qz1uu.r-417010.r-18u37iz > main > div > div > div > div.css-175oi2r.r-kemksi.r-1kqtdi0.r-1ua6aaf.r-th6na.r-1phboty.r-16y2uox.r-184en5c.r-1abdc3e.r-1lg4w6u.r-f8sm7e.r-13qz1uu.r-1ye8kvj > div > div:nth-child(3) > div > div > div:nth-child(1) > div > div.css-175oi2r.r-13awgt0.r-18u37iz.r-1w6e6rj > div:nth-child(2) > a > span.css-1jxf684.r-bcqeeo.r-1ttztb7.r-qvutc0.r-poiln3.r-1b43r93.r-1cwl3u0.r-b88u0q > span'
PAGE_Account_info_First_tweet_info = '#react-root > div > div > div.css-175oi2r.r-13qz1uu.r-417010.r-18u37iz > main > div > div > div > div > div > div:nth-child(3) > div > div > section > div > div > div:nth-child(1)'
...
if __name__== '__main__':
    ...
    ##########################################################계정정보 다른곳에 넣기################################################################
    ##########################################################계정정보 다른곳에 넣기################################################################
    driver.find_element(By.CLASS_NAME,PAGE_login_field).send_keys("RPS_Heidi")
    ##########################################################계정정보 다른곳에 넣기################################################################
    ##########################################################계정정보 다른곳에 넣기################################################################
    ...
    ##########################################################계정정보 다른곳에 넣기################################################################
    ##########################################################계정정보 다른곳에 넣기################################################################
    driver.find_element(By.CLASS_NAME,PAGE_login_field).send_keys("fulcrum0324")
    ##########################################################계정정보 다른곳에 넣기################################################################
    ##########################################################계정정보 다른곳에 넣기################################################################
    ...
    data = pd.read_csv('final_2501.csv') 
    ...
    for i, item in enumerate(id_list[0:],0):
        ...
        if isinstance(item, float) and math.isnan(item):
            ...
            # print(data.iloc[i])
        data.to_csv("final2501.csv",index=False,encoding="utf-8-sig")
