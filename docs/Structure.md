...
├── {YY년_M월}_부스정보_normalized.csv # [JWMI-5] 정규화 결과 (_정규화/_코드 컬럼 추가)
│
...
### 매칭 통계 (v1.2 사전, 전체 14,765셀)

| 항목 | v1.0 | v1.1 | v1.2 |
|---|---:|---:|---:|
| 매칭 성공 셀 | 11,454 | 12,192 | 12,430 |
| 매칭률 | 77.58% | 82.57% | **84.19%** |
| 등장 작품 수 | 210 | 367 | 444 |
| 사전 등재 | 211 | 369 | **446** |
| 처리율 (코드 부여 또는 명시 분류) | — | — | **97.81%** |

> v1.2의 명시 분류: 판단 불가 133셀 + 노이즈 265셀. 잔여 unmatched 323셀(고유 354종)은
> `analysis/unmapped_review_*.csv` 사람 확인 대상
